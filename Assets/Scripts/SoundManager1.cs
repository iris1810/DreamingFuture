...
public class SoundCollection1 {
  private AudioClip[] clips;
  private int lastClipIndex;

  public SoundCollection1(params string[] clipNames) {
...
public class SoundManager1 : MonoBehaviour {
  ...
  private Dictionary<SoundType1, SoundCollection1> sounds;
  ...
  private void Awake() {
    ...
    sounds = new() {
      ...
      {SoundType1.WIN, new SoundCollection1("Win") },
    };
  }

  public static void Play(SoundType1 type, AudioSource audioSrc = null, float pitch = -1) {
